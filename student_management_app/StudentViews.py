...
def student_home(request):
    ...
    return render(request, "student_template/student_home_template.html", {"total_attendance":total_attendance, "attendance_present": attendance_present,
                   "attendance_absent": attendance_absent, "subjects": subjects, "subject_name": subject_name,   "data_present": data_present, "data_absent": data_absent})
